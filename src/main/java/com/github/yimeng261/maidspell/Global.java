...
public class Global {
    ...
    public static final List<BiFunction<LivingIncomingDamageEvent, EntityMaid,Void>> commonDamageCalc = new CopyOnWriteArrayList<>();

    public static final List<BiFunction<LivingIncomingDamageEvent,Player,Void>> playerHurtCalcAft = new CopyOnWriteArrayList<>();
    ...
    public static final Map<Item,BiFunction<LivingDamageEvent.Post,EntityMaid,Void>> baubleDamageCalcAft = new ConcurrentHashMap<>();

    public static final Map<Item,BiFunction<LivingIncomingDamageEvent,EntityMaid,Void>> baubleDamageCalcPre = new ConcurrentHashMap<>();

    public static final Map<Item,BiFunction<LivingIncomingDamageEvent,EntityMaid,Void>> baubleCommonHurtCalcPre = new ConcurrentHashMap<>();
