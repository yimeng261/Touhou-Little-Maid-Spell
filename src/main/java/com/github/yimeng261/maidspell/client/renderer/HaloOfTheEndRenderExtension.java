...
import com.github.yimeng261.maidspell.client.renderer.layer.GeckoLayerHaloOfTheEnd;
 ...
 */
@LittleMaidExtension
public class HaloOfTheEndRenderExtension implements ILittleMaid {
    ...
    public void addAdditionGeckoMaidLayer(GeckoEntityMaidRenderer<? extends Mob> renderer, EntityRendererProvider.Context context) {
        renderer.addLayer(new GeckoLayerHaloOfTheEnd(renderer));
    }
    ...
    public void addAdditionMaidLayer(EntityMaidRenderer renderer, EntityRendererProvider.Context context) {
        ...
        // renderer.addLayer(new LayerHaloOfTheEnd(renderer));
    }
}
