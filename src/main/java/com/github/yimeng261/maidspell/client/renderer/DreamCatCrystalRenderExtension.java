...
import com.github.yimeng261.maidspell.client.renderer.layer.GeckoLayerDreamCatCrystalHalo;
...
@LittleMaidExtension
public class DreamCatCrystalRenderExtension implements ILittleMaid {
    @Override
    @OnlyIn(Dist.CLIENT)
    ...
    public void addAdditionGeckoMaidLayer(GeckoEntityMaidRenderer<? extends Mob> renderer, EntityRendererProvider.Context context) {
        renderer.addLayer(new GeckoLayerDreamCatCrystalHalo(renderer));
    }
