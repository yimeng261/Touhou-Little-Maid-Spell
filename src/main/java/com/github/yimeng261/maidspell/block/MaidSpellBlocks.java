...
public final class MaidSpellBlocks {
    ...
    public static final DeferredBlock<SuppressionStoneBlock> SUPPRESSION_STONE =
            BLOCKS.registerBlock("suppression_stone", SuppressionStoneBlock::new, SuppressionStoneBlock.createProperties());
