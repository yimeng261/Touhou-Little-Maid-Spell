...
public class SpringRing extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        TooltipHelper.addShiftTooltip(tooltip,
            List.of(
                Component.translatable("item.maidspell.spring_ring.desc1")
                    .withStyle(ChatFormatting.GRAY)
            ),
            List.of(
                Component.translatable("item.maidspell.spring_ring.desc2")
                    .withStyle(ChatFormatting.BLUE),
                Component.translatable("item.maidspell.spring_ring.desc3",
