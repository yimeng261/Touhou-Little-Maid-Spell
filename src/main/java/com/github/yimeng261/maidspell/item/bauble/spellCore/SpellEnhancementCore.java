...
public class SpellEnhancementCore extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        TooltipHelper.addShiftTooltip(tooltip,
            List.of(
                Component.translatable("item.maidspell.spell_enhancement_core.desc1")
                    .withStyle(ChatFormatting.GRAY)
            ),
            List.of(
                Component.translatable("item.maidspell.spell_enhancement_core.desc2")
                    .withStyle(ChatFormatting.BLUE),
                Component.translatable("item.maidspell.spell_enhancement_core.desc3")
