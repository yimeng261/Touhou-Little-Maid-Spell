...
public class ArcCrossBauble implements IMaidBauble {
    ...
    public void onTick(EntityMaid maid, ItemStack baubleItem) {
        ...
        refreshEffect(maid, MobEffectRegistry.THUNDERSTORM.get());
        refreshEffect(maid, MobEffectRegistry.FORTIFY.get());
    }

    private static void refreshEffect(EntityMaid maid, MobEffect effect) {
