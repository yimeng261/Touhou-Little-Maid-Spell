...
public enum TransmogHaloStyle {
    DREAM_1(
        "dream_1",
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_1.png"),
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_1_gui.png"),
        "gui.maidspell.transmog_necklace.style.dream_1"
    ),
    DREAM_2(
        "dream_2",
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_2.png"),
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_2_gui.png"),
        "gui.maidspell.transmog_necklace.style.dream_2"
    ),
    DREAM_3(
        "dream_3",
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_3.png"),
        new ResourceLocation(MaidSpellMod.MOD_ID, "textures/entity/maid/halo_deco/dream_halo_dec_3_gui.png"),
