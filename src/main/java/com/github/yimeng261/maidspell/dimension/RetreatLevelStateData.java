...
public class RetreatLevelStateData extends SavedData {
    ...
    public static RetreatLevelStateData load(CompoundTag tag, HolderLookup.Provider registries) {
    ...
    public static RetreatLevelStateData get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(
            new SavedData.Factory<>(RetreatLevelStateData::new, RetreatLevelStateData::load),
            DATA_NAME
        );
    }
    ...
    public void capture(RetreatLevelData levelData) {
        ...
        BlockPos spawn = levelData.getSpawnPos();
