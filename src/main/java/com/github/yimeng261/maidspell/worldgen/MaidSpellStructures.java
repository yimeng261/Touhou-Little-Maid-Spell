...
public class MaidSpellStructures {
    ...
    // 隐世樱花树（带水面检测）
    public static final DeferredHolder<StructureType<?>, StructureType<HiddenCherryTreeStructure>> HIDDEN_CHERRY_TREE
            = STRUCTURE_TYPES.register("hidden_cherry_tree", () -> () -> HiddenCherryTreeStructure.CODEC);
}
