...
import com.github.yimeng261.maidspell.worldgen.structure.HidenRetreatStructure;
...
public class MaidSpellStructures {
    ...
    // 隐居之地结构（基于拼图系统）
    public static final RegistryObject<StructureType<HidenRetreatStructure>> HIDEN_RETREAT = STRUCTURE_TYPES.register(
            "hiden_retreat", 
            () -> () -> HidenRetreatStructure.CODEC
    );
}
